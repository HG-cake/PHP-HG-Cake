...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr  class="tdbg" id="dis_uselink" <?php echo ($row['uselink']=='yes')?'':'style="display:none;"'?> >
    ...
    <td>
    <input type="checkbox" name="uselink" id="uselink" value="yes" <?php echo ($row['uselink']=='yes')?' checked':''?> onClick="checklink()">
    <input name="link_url" type="text" id="link_url" size="57" maxlength="150" disabled="yes" value="<?php echo ($row['link_url']!='')?$row['link_url']:'http://'?>">
    </td>
  </tr>
  ...
  <tr class="tdbg"  id="dis_z_body">
    ...
    <td>
		<script id="editor" type="text/plain" style="width:1024px;height:500px;"><?php echo $row['z_body']?></script>
    </td>
  </tr>
  <tr class="tdbg" id="dis_img_sl" style="display:none;">          
    <td width="120" align="right">图片上传：</td>          
    <td ><IFRAME style="margin-top:2px;" height="22" src="uploadd.php?frameid=frame1&kuang=img_sl&img_sl=<?php echo $row['img_sl']?>&s_pic=<?php echo $s_pic?>&s_typ=<?php echo $s_typ?>&s_wid=<?php echo $s_wid?>&s_hei=<?php echo $s_hei?>" width="280" frameborder=0  scrolling=no name="frame1" id="frame1" ></iframe><input type="hidden" name="img_sl" id="img_sl" value="<?php echo $row['img_sl']?>"> 图片尺寸：(banner 1201px*447px)</td>
  </tr>
    <tr class="tdbg" id="dis_dow_sl" style="display:none;">          
        <td width="120" align="right">文件上传：</td>          
        <td ><IFRAME name="frame2" id="frame2" style="margin-top:2px;"height=22 src="updloadd.php?frameid=frame2&kuang=dow_sl&img_sl=<?php echo $row['dow_sl']?>" width="280" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="dow_sl" id="dow_sl" value="<?php echo $row['dow_sl']?>"></td>
    </tr>
    <tr class="tdbg" id="dis_vid_sl" style="display:none;" >          
        <td width="120" align="right">视频上传：</td>          
        <td ><IFRAME name="frame3" id="frame3" style="margin-top:2px;"height=22 src="upvloadd.php?frameid=frame3&kuang=vid_sl&img_sl=<?php echo $row['vid_sl']?>" width="280" frameborder=0  scrolling=no  ></iframe><input type="hidden" name="vid_sl" id="vid_sl" value="<?php echo $row['vid_sl']?>"></td>
    </tr>
