...
gt('formn').action="upvload.php?frameid=<?php echo $frameid?>&kuang=<?php echo $kuang?>&s_pic=<?php echo $s_pic?>&s_typ=<?php echo $s_typ?>&s_wid=<?php echo $s_wid?>&s_hei=<?php echo $s_hei?>"
gt('formn').submit();
} 
// 是否有效的扩展名
