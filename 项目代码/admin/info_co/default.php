...
?>
    <tr class="tdbg">
        ...
        <td><?php echo '<b>[</b>'.$row['title_lm'].'<b>] </b><a href="edit.php?id='.$row['id'].'" '.(($row['color_font']!='')?'style="color:'.$row["color_font"].'"':'').'>'.$row['title'].'</a> '.(($row['img_sl']!='')?'<a href="../../'.$row['img_sl'].'"  target=_blank><img src="../images/img.gif" border="0" onmouseover="popImage(this,\'../../'.$row['img_sl'].'\');" onmouseout="hideLayer();"/></a>':'')?></td>
