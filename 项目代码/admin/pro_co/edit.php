...
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
  ...
  <tr class="tdbg">
    ...
    <td><INPUT name="title" type="text" id="title" size="60" maxlength="80" value="<?php echo $row['title']?>"> <span class="red">*</span></td>
  </tr>
  <tr class="tdbg">
    <td width="120" align="right">售价：</td>
    <td><INPUT name="pro_can1" type="text" id="pro_can1" size="30" maxlength="80" value="<?php echo $row['pro_can1']?>"></td>
  </tr>
  ...
  <tr>
    <td>产地：</td>
    <td><INPUT name="" type="text" id=""  maxlength="50" value="<?php echo $row['pro_can1']?>"></td>
    <td>规格：</td>
  ...
  <tr class="tdbg">          
    ...
    <td ><IFRAME style="margin-top:2px;"height=22 src="uploadd.php?frameid=frame1&kuang=img_sl&img_sl=<?php echo $row['img_sl']?>" width="280" frameborder=0  scrolling=no name="frame1" id="frame1"></iframe><input type="hidden" name="img_sl" id="img_sl" value="<?php echo $row['img_sl']?>"></td>
  </tr>
    <tr class="tdbg">
